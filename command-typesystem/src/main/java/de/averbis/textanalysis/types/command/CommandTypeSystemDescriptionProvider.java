...
public class CommandTypeSystemDescriptionProvider extends TypeSystemProvider_ImplBase {

	public CommandTypeSystemDescriptionProvider() {

		setTypeSystemLocations("CommandTypeSystem.xml");
	}
}
